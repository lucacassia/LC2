...
<\body>
  ...
  <\big-figure|<image|../hardcore2d/distribution/img/mdistribution.pdf|0.75par|||>>
    ...
    particles. The system is initialized at temperatures <math|T=1,4,16>.
  </big-figure>
  ...
  time of <math|5\<cdot\>10<rsup|4>> collisions. \ The errorbars represent
  the standard errors of the averages. At large values of <math|\<eta\>>
  (<math|\<sim\>*0.75>) the system takes more time to reach thermal
  equilibrium and this means that measurements are collected when the system
  is not yet completely mixed. For this reason larger fluctuations are
  introduced between different simulation runs and the errors are greater.>
  ...
  after a thermalization of <math|5\<cdot\>10<rsup|4>> collisions.>
  ...
  <\collection>
    <\associate|figure>
      ...
      <\tuple|normal>
        ...
        momenta of <with|mode|<quote|math>|N> particles. The system is
        initialized at temperatures <with|mode|<quote|math>|T=1,4,16>.
      ...
      averages. At large values of <with|mode|<quote|math>|\<eta\>>
      (<with|mode|<quote|math>|\<sim\>*0.75>) the system takes more time to
      reach thermal equilibrium and this means that measurements are
      collected when the system is not yet completely mixed. For this reason
      larger fluctuations are introduced between different simulation runs
      and the errors are greater.|<pageref|auto-10>>
      ...
      thermalization time of <with|mode|<quote|math>|5\<cdot\>10<rsup|4>>
